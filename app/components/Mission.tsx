  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 py-12 md:py-16 font-sans">
      ...
      <div className="text-center  mb-16  mx-auto">
        <h1 className="text-[20px] md:text-[32px] px-4 font-semibold uppercase leading-tight text-gray-900">
      ...
      <div className="flex flex-col gap-20 px-4 md:px-10">
        ...
        */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:border md:border-[#F998BB]   md:p-16 items-center relative">
          ...
          */}
          <div className="space-y-2 md:space-y-6 z-10 border border-[#F998BB] p-6 md:border-0 md:p-0">
           <h2 className="text-[24px] md:text-4xl font-bold text-gray-900">
  About <span className="text-[#FF1376]">Ngo <span className="inline md:hidden">Foundation</span></span>
</h2>
            <div className="flex md:mt-0 mt-4 items-center">
              <div className="w-5 h-5 bg-[#FF1376] mr-3 shrink-0"></div>
              <h3 className="text-[16px] font-bold text-[#131313]">Who we are-</h3>
            </div>

            <p className="text-[#131313] leading-relaxed max-w-[500px] md:min-w-full ml-4 md:ml-0 md:mt-0 mt-8  text-[12px] md:text-[18px] md:text-base">
          ...
          <div className="relative flex justify-center md:justify-end mt-10 md:mt-0">
            ...
            <div className="hidden md:block absolute top-[-30px] md:left-12 -z-10">
                <Image 
                    src={ellipse} 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
          ...
          {/* Right Text Content */}
          <div className=" border border-[#FDC5DA] p-4 gap-4">
            <div className="flex items-center">
              <div className="w-5 h-5 bg-[#FF1376] mr-3 shrink-0"></div>
              <h3 className=" text-[16px] md:text-[24px] font-bold text-[#131313] ">Our Vision and mission</h3>
            </div>

            <p className="text-[12px] md:text-[20px] mt-0 md:mt-4 font-medium leading-11 text-[#121212]">
              "Unlocking Potential, Creating Opportunities."
            </p>

            <p className="text-[#121212] max-w-[400px] md:min-w-full font-normal text-[12px] md:text-[18px] leading-[27px] md:text-base">
            ...
            <button className="group bg-[#131313] text-white w-full justify-center font-medium py-3 px-6 rounded-sm flex items-center transition-all duration-300 mt-4">
              Become Our Member 
