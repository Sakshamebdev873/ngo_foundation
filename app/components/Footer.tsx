      ...
      */}
      <div className="bg-[#181818] text-white rounded-t-[40px] md:rounded-t-[60px] px-6 py-12 md:px-12 md:py-12 lg:px-24">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          {/* --- Main Grid Content --- */}
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20  pb-16">
            ...
            <div className="lg:col-span-5 space-y-10">
              ...
              {/* Logo Area */}
              <div>
                <h2 className="text-3xl foot font-bold italic tracking-wide">Ngo</h2>
                <h1 className="text-3xl font-serif tracking-wider text-white">Foundation</h1>
              </div>

              {/* Core Values Text */}
              <div className="space-y-4">
                <h3 className="text-[#F998BB] foot_1   font-bold text-[20px]">Core Values</h3>
              ...
              {/* Newsletter Section */}
              <div className="space-y-4">
                <h3 className="text-[#F998BB]  font-semibold text-xl leading-6">Sign up for our newsletter</h3>
                <form className="flex flex-col sm:flex-row gap-4">
                  <input 
                    type="email" 
                    placeholder="Email" 
                    className="w-full bg-transparent border border-gray-600 rounded-sm px-4 py-3 foot_1 font-normal text-[18px] text-white placeholder-gray-400 focus:outline-none focus:border-[#D62062] transition-colors"
                  />
                  <button 
                    type="button"
                    className="bg-[#D62062] hover:bg-[#b0164d] text-white font-semibold text-[16px] py-3 px-8 rounded-sm transition-colors"
                  >
                    Signup
                  </button>
                </form>
            ...
            <div className="lg:col-span-3 lg:pl-8">
              <h3 className="text-[#F998BB] foot_1  text-[16px] font-semibold mb-8">Useful links</h3>
              <ul className="space-y-6 font-normal text-[#FFFFFF]">
                <li>
            ...
            <div className="lg:col-span-4">
              <h3 className="text-[#F998BB] foot_1 font-semibold text-xl mb-8">Our contacts</h3>
          ...
          <div className="pt-4 text-center text-white text-sm leading-6 flex flex-col md:flex-row justify-center gap-2 md:gap-8">
            <p>© Charity 128. All Rights Reserved 2025.</p>
            <Link href="#" className="text-white transition-colors">Licensing</Link>
          </div>
